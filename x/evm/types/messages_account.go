...
func NewMsgCreateAccount(creator string, codeHash string) *MsgCreateAccount {
...
func NewMsgUpdateAccount(creator string, id uint64, codeHash string) *MsgUpdateAccount {
