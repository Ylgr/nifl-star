...
var (
	pattern_Query_Account_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"ylgr", "niflstar", "evm", "account", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AccountAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ylgr", "niflstar", "evm", "account"}, "", runtime.AssumeColonVerbOpt(true)))
)
