...
const baseMsgCreateAccount = { creator: "", codeHash: "" };
...
const baseMsgUpdateAccount = { creator: "", id: 0, codeHash: "" };
...
export class MsgClientImpl {
    ...
    CreateAccount(request) {
        ...
        const promise = this.rpc.request("ylgr.niflstar.evm.Msg", "CreateAccount", data);
    ...
    UpdateAccount(request) {
        ...
        const promise = this.rpc.request("ylgr.niflstar.evm.Msg", "UpdateAccount", data);
    ...
    DeleteAccount(request) {
        ...
        const promise = this.rpc.request("ylgr.niflstar.evm.Msg", "DeleteAccount", data);
