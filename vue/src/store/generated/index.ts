...
import YlgrNiflStarYlgrNiflstarEvm from './ylgr/nifl-star/ylgr.niflstar.evm'
...
export default { 
  ...
  YlgrNiflStarYlgrNiflstarEvm: load(YlgrNiflStarYlgrNiflstarEvm, 'ylgr.niflstar.evm'),
